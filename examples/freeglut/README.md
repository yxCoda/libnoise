...
This is a WIN32 ONLY version of the original freeglut!!!
As Windows lacks a effecient way to manage packages. 
While on linux it is much easier to configure the library.

For the original freeglut, read the following information.
